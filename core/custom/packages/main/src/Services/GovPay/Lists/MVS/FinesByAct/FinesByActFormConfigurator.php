...
use EvolutionCMS\Main\Services\GovPay\Fields\Base\TotalField;
...
class FinesByActFormConfigurator extends BaseFormConfigurator implements IFormConfigurator
{
    ...
    public function getFormConfig(): array
    {
        ...
        $regions = PencodesItem
            ::select()
//            ::where('name_ua','!=','ФОТОФІКСАЦІЯ')
            ->orderBy('id')->get()->pluck('name_ua','id')->toArray();
