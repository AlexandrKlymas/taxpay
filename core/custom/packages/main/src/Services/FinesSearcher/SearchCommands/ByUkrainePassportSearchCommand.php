...
class ByUkrainePassportSearchCommand implements IFineSearchCommand
{
    /**
     * @var IFinesApi|mixed
     */
    ...
    {
        return $this->finesApi->searchFinesByUkrainianPassport($this->getSeries(),$this->getNumber(),$this->getLicensePlate());
