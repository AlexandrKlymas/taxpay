            ...
            <div class="container header-container">
                ...
                <div class="search-wrap">
                    ...
                    <div class="search" id="searchBlock">
                        <form class="form">
                            <input name="search" v-model="inputValue" type="text" autocomplete="off" placeholder="Пошук">
                ...
                <div class="header-right">
                        ...
                        <ul>
                            ...
                            @foreach($menu as $item)
                                @if(isset($item['children']))
                                    <li class="menu-item-has-children"><a href="{{ UrlProcessor::makeUrl( $item['id'] ) }}">{{ $item['pagetitle'] }}</a>
                                        <ul>
                                            @foreach($item['children'] as $child)
                                            <li class="{{ $child['id'] == $documentObject['id'] ?'current-menu-item':''}}"><a href="{{ UrlProcessor::makeUrl( $child['id'] ) }}">{{ $child['pagetitle'] }}</a></li>
                                            @endforeach
                                        </ul>
                                    </li>
                                @else
                    ...
                    <a href="#feedbackModal" class="btn-callback" data-toggle="modal">Зворотній зв’язок</a>
                </div>
