            ...
            <div class="successful-footer">
                <a href="https://g.page/r/CdkOit5wOm2XEAg/review" target="_blank" class="successful-btn btn-review">
                    <span class="btn-review__text btn-review__text--desktop">
                        We are interested in your opinion about the service<br>
                        Please leave your feedback
                    </span>
                    <span class="btn-review__text btn-review__text--mobile">
                        Your feedback and opinion about the service
                    </span>
                </a>

                <button class="successful-btn btn-pwa tooltip" data-pwa-btn style="display: none">Add GOVPAY24
                    on the home screen
                    <div class="tooltiptext">To install the application you need to click on the toolbar
                        Safari icon <img width="50" height="50" src="/theme/images/share-icon.jpg" alt=""></div>
                </button>
            </div>
        ...
        <div class="modal-sm modal-dialog modal-dialog-centered send-to-email" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <p class="modal-title">Send a receipt to Email</p>
                </div>
