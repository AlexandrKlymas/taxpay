...
<html>
    ...
    <body style="background-color: #fafafa;width:97%;">
        <div id="wbx_table" style="padding-bottom:20px;width:100%"></div>
            ...
            webix.ui({
                ...
                rows:[
                    ...
                    { view:"datatable",
                        ...
                        url: "[+module_url+]action.php?action=list&module_id=[+module_id+]&tab_action=[+tab_action+]&document_id=[+document_id+]&service_id=[+service_id+]&region_id=[+region_id+]",
